...
async def register(user_create: UserCreate, db: Session = Depends(get_db)):
    ...
    try:
        ...
        try:
            EmailService.send_welcome_email(user.email, user.full_name or user.email.split('@')[0])
...
async def change_password(
    ...
    # Update password
    UserService.update_user_password(db, current_user.id, password_update.new_password)
...
async def get_user_profile(
    ...
    profile_stats = UserService.get_user_profile_stats(db, current_user.id)
